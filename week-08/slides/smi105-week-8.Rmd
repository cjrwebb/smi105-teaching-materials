...
decktape generic --key=ArrowRight --load-pause 1800 --slides '1-62' --size '1216x684' --url-load-timeout 80000 --page-load-timeout 40000 "week-08/slides/smi105-week-8.html" week-08/slides/smi105-week-8.pdf
...
.center[Has the area you live in gotten more or less popular for house buyers over that 20 year time span?]

.pull-left[

.center[
__[House Sales in 1998](https://calumwebb.co.uk/teaching/SMI606-content/week-11/shef_sales_1998/)__:  bit.ly/sheff-1998

```{r, echo = FALSE, out.width="50%"}

knitr::include_graphics("images/qrcode-1998.png")
...
.center[
__[House Sales in 2018](https://calumwebb.co.uk/teaching/SMI606-content/week-11/shef_sales_2018/)__: bit.ly/sheff-2018


```{r, echo = FALSE, out.width="50%"}

knitr::include_graphics("images/qrcode-2018.png")
...
* Knowing the spatial characteristics of a societal phenomenon or problem (how concentrated or dispersed it is) can help in designing effective solutions. For example:<br><br>
  * Targeted mailing to residences in certain areas about subsidised insulation programmes.<br><br>
  * Identifying potentially effective areas for place-based intervention, e.g. drug harm reduction facilities in areas with high rates of drug overdose.<br><br>
...
__Interactivity__ is increasingly used as a way to allow users to explore at various levels of scale.
...
```{r, echo = FALSE, out.width = "60%", fig.cap="Map of Indigenous Territories overlaid on Settler territories in Canada"}
...
.center[
```{r, echo = FALSE, out.width = "75%", fig.cap="Map of Pāhekā Colonial territories in Aotearoa New Zealand in 1858"}

knitr::include_graphics("images/800px-New_Zealand_in_1858.svg.png")
...
```{r, echo = FALSE, out.width = "80%", fig.cap="Map of Māori Iwi in Aotearoa New Zealand"}

knitr::include_graphics("images/IwiMap.png")
...
.center[
```{r, echo = FALSE, out.width = "95%", fig.cap="Original Chinese Map of Minority Ethnic Groups in China"}

knitr::include_graphics("images/original-map.jpg")
...
```{r, echo = FALSE, out.width = "95%", fig.cap="Translated Map of Minority Ethnic Groups in China"}

knitr::include_graphics("images/map-of-the-week.gif")
...
<div class="tenor-gif-embed" data-postid="17118549" data-share-method="host" data-aspect-ratio="1.44796" data-width="80%"><a href="https://tenor.com/view/mercator-vs-true-world-map-true-coutry-size-original-world-map-world-map-real-world-shrink-gif-17118549">Mercator Vs True World Map True Coutry Size GIF</a>from <a href="https://tenor.com/search/mercator+vs+true+world+map-gifs">Mercator Vs True World Map GIFs</a></div> <script type="text/javascript" async src="https://tenor.com/embed.js"></script>
...
* We can represent spatial data visually through various types of maps: most commonly we use a static __choropleth__, but we may also wish to use __interactive maps__ or __cartograms__ to adjust for things like population size (remember: people vote, land doesn't vote!).
